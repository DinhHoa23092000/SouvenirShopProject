...
INSERT INTO `Product`(`name`, `image`, `price`, `type`, `detail`) VALUES ("ĐỒNG HỒ CÁT HỘP BÚT","Souvernir/Product/QuaDeBan/donghocathopbut.jpg",60000 , "QUÀ ĐỂ BÀN","Sản phẩm đồng hồ cát hộp bút kim loại phong cách cổ điển này cũng là 1 trong những món đồ tiện tích, tích hợp tính năm cắm bút để trên bàn học, bàn làm việc….");
INSERT INTO `Product`(`name`, `image`, `price`, `type`, `detail`) VALUES ("ĐỒNG HỒ CÁT VINTAGE","Souvernir/Product/QuaDeBan/donghocatvintage.jpg",55000 , "QUÀ ĐỂ BÀN","Đồng hồ cát vintage cổ điển xoay 360 độ với thời gian cát chảy 15 phút sẽ là món đồ trang trí cho căn phòng của bạn thêm ấn tượng nổi bật với một phong cách Châu Âu bán cổ điển, hiện đại.");
INSERT INTO `Product`(`name`, `image`, `price`, `type`, `detail`) VALUES ("CHUÔNG GIÓ CẦU THỦY TINH TOTORO","Souvernir/Product/QuaTangPhaLe/chuonggio.jpg",12000 , "QUÀ TẶNG PHA LÊ","CHUÔNG GIÓ TRANG TRÍ NHẬT BẢN VINTAGE điều ước lọ thủy tinh Cực kỳ dễ thương, sắc nét bạn có thể làm quà tặng hoặc trang trí góc phòng với những chiếc chuông gió xinh xắn, trang trí theo phong cách vintage");
INSERT INTO `Product`(`name`, `image`, `price`, `type`, `detail`) VALUES ("BÚT KÍ KIM LOẠI CAO CẤP","Souvernir/Product/But/butkikimloaicaocap.jpg",25000 , "BÚT","Bút kim loại  là từ khi sự phát triển công nghệ chưa bùng nổ. Việc sử dụng một chiếc bút kim loại cao cấp và chất lượng vẫn luôn thể hiện được hình ảnh đặc biệt của  con người trong công việc.");
create table User(
id int primary key AUTO_INCREMENT,
fullName varchar(50),
