        ...
        <div class="header-container">
            ...
            ?>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <!--input type="file" name="imagePr" id="" value="<?php echo $Products[$i]->getImagePath()?>" placeholder=""-->
                                            </div>
                                        </div>
                    ...
                    for($i=0;$i<count($resultOrder);$i++){ ?>
                        <div id="modalOrderDetail<?php echo $resultOrder[$i][0]?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="my-modal-title" style="margin-left: 180px; color: firebrick">ORDER DETAIL</h5>
                                            <button class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <div class="modal-body">
                                            <table align="center" width="600px" border="1" cellspacing="0" cellpadding="3" class="table table-hover table-bordered" id="mytable">
                                                ...
                                                <?php 
                                                    ...
                                                    echo '<td style="text-align: center;">'.'<button class="OrderDetail" data-toggle="modal" data-target="#modalOrderDetail'.$resultOrder[$i][0].'" name="id" value="'.$result[$i][0].'"  style="border: none"><i class="fa fa-newspaper"></i></button>'.'</td>';
                                                    echo '</tr>';
                                                ?>
                                            </table>
                                        </div>
                        ...
                        <?php for($i = 0; $i < count($Products); $i++){  ?>
                            <figure class="grid-item">
                                ...
                                <figcaption>
                                    ...
                                    <p style="font-size: 13px;margin-top: 10px; text-align: center; color:midnightblue; font-weight: bold;">Price: 
                                        <?php 
                                        echo $Products[$i]->getPrice();
                                        ?>
                                    </p>
                                    <form action="detail.php" method="get">
                                        <button class="detail" name="detail" value="<?php echo $i?>">Xem Chi Tiết</button>
                                    </form>
                                </figcaption>
                                <form action="" method="post">
