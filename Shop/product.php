...
$ht = "SELECT * from Product where type='".$type."'";
...
<html lang="en">
    ...
    <body>
        <div class="header-container">
                            ...
                            <ul class="clearfix">
                                ...
                                <li>
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li><a href="product.php" name="type1" value="QUÀ ĐỂ BÀN">QUÀ ĐỂ BÀN</a></li>
                                        <li><a href="product.php" name="type2" value="QUÀ TẶNG PHA LÊ">QUÀ TẶNG PHA LÊ</a></li>
                                        <li><a href="product.php">GẤU BÔNG</a></li>
                                        <li><a href="product.php">MÓC KHÓA</a></li>
                                        <li><a href="product.php">BÚT</a></li>
                                        <li><a href="product.php">TIỆN ÍCH</a></li>
                                        <li><a href="product.php">ĐỒ MĨ NGHỆ</a></li>
                                        <li><a href="product.php">SẢN PHẨM SÀNH SỨ</a></li>
                                        </form>
                                    </ul>
                                </li>
                                <li>
            ...
            <h3 style="color:firebrick; text-align: center; margin-bottom: 30px;"><?php echo $type ?></h3> 
            <!----------------------Hien thi danh sach sp tim kiem------------------------>
            <div class="grid-container">
                <?php for ($i = 0; $i < count($searchType); $i++) {  ?>
                <figure class="grid-item">
                    <img class="img-fluid d-block mx-auto" src="<?php echo $searchType[$i][2] ?>" style="padding: 5px 5px 5px 5px">
                    <figcaption>
                    ...
                    <div style="display: flex">
                        <form action="" method="post">
                            <button name="insert_cart" value="<?php echo $searchType[$i][0];?>"> <i class="fa fa-shopping-cart" style="font-size:20px;color:red"></i></button>
                        </form>
                        <form action="detail.php" method="get">
                        <button name="detail" value="<?php echo $searchType[$i][0]?>"> <i class="fa fa-shopping-cart" style="font-size:20px;color:blue"></i></button>
                        </form>
                    </div>
                </figure>
                <?php }?>
